...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideColor = a.getColor(R.styleable.CircleProgressBar_outside_color, context.getColor(R.color.colorPrimary));
        outsideRadius = a.getDimension(R.styleable.CircleProgressBar_outside_radius, DimenUtil.dp2px(getContext(), 60.0f));
        insideColor = a.getColor(R.styleable.CircleProgressBar_inside_color, context.getColor(R.color.gray));
        dotColor = a.getColor(R.styleable.CircleProgressBar_dot_color, context.getColor(R.color.white));
        progressTextColor = a.getColor(R.styleable.CircleProgressBar_progress_text_color, context.getColor(R.color.colorPrimary));
        progressTextSize = a.getDimension(R.styleable.CircleProgressBar_progress_text_size, DimenUtil.dp2px(getContext(), 25.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF dot_oval = new RectF(circlePoint - outsideRadius, circlePoint - outsideRadius, circlePoint + outsideRadius, circlePoint + outsideRadius);
        float degree = -360 * (progress / maxProgress);
        degree -= 90;
        degree = (float) (Math.PI  * degree / 180f);      
        canvas.drawCircle((float) (dot_oval.left + dot_oval.width() / 2f + outsideRadius * Math.cos(degree)), //圆心x
            (float) (dot_oval.top + dot_oval.height() / 2f + outsideRadius * Math.sin(degree)), //圆心y
            5f,
            paint);        
    }
